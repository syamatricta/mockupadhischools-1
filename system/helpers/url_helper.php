...
if (!function_exists('check_force_non_ssl'))
{
	...
	if(!$is_ssl_url && $_SERVER['SERVER_PORT'] == 443){
		...
		$CI->config->config['style_url'] =    str_replace('http://', 'https://', $CI->config->config['style_url']);
		$CI->config->config['script_url'] =    str_replace('http://', 'https://', $CI->config->config['script_url']);
...
if(!function_exists('is_ssl_page_url')){
 function is_ssl_page_url (){
	...
	$ssl_uris = array(
		        ...
		        array('r1' => 'user' , 'r2' => 'login') ,
		        array('r1' => 'register_ajax' , 'r2' => 'register') ,
		        array('r1' => 'user' , 'r2' => 'forgot_password') ,
		        array('r1' => 'user' , 'r2' => 'renewal') ,
		        array('r1' => 'user' , 'r2' => 'listremainingcourse') ,
		        array('r1' => 'course' , 'r2' => 'courselist') ,
		        ...
		        array('r1' => 'register_ajax' , 'r2' => 'iframe_get_ship'),                
		        array('r1' => 'course' ,        'r2' => 'update_progress'),                
                        ...
                        array('r1' => 'to_cco',         'r2' => 'user_register')
		        );
	$is_ssl_url = true;
	return $is_ssl_url;
