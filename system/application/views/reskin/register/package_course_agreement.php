    ...
    <div class="modal-content"> 
      <div class="modal-header">
       ...
       <div class="modal-body">
      		...
      		<!--<p>PAGE1-PACKAGE COURSE AGREEMENT - General Information Page</p>
      	...
      	<div class="row termspop">
      		<div class="col-md-3 col-sm-5  text-left">
      			<div class="checkbox  checkbox-info" >
			        ...
			        <label for="iagree" > <div class="agreelabel">I Agree</div> </label>
			    </div>
      		</div>
      		<div class="col-md-9 col-sm-7  text-left">
      			<div class="checkbox  checkbox-info" >
		 			<input type="checkbox" name="inoagree" id="inoagree">
			        <label for="inoagree"> <div class="agreelabel">I Don't Agree</div></label>
			    </div>
      		</div>
      	</div>         
      </div>
