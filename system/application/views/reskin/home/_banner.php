  ...
  <div class="middle">
    <div class="left_bg">
        <nav class="nav navbar">
          <li><a href="https://twitter.com/adhischools/" target="_blank"><span class="fa fa-twitter"></span></a></li> 
          <li><a href="https://facebook.com/adhischools/" target="_blank"><span class="fa fa-facebook"></span></a></li> 
          <li><a href="https://www.youtube.com/channel/UCKnNFzHOoFcrh0vNBRWcEBQ" target="_blank"><span class="fa fa-youtube"></span></a></li> 
          <li><a href="https://www.instagram.com/adhischools/" target="_blank"><span class="fa fa-instagram"></span></a></li> 
          <li><a href="https://www.yelp.com/biz/adhi-schools-newport-beach" target="_blank"><span class="fa fa-yelp"></span></a></li> 
          <li><a href="https://www.adhischools.com/blog/" target="_blank"><span class="fa fa-wordpress"></span></a></li>     
        </nav>
    </div>
  </div>
</div>
                    ...
                    <div class="banner-content">
                        <div class="row btext margin40">
                            <div class="col-md-9 col-xs-12">
                                <h1>California's most <span>comprehensive real estate</span><span> school</span></h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="<?php echo base_url();?>find-real-estate-classes" class="banner-btn btn_margin ml5">Learn more</a>
            ...
            <div class="carousel-caption">
                <div class="container">
                    <div class="banner-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="https://www.crashcourseonline.com" class="banner-btn btn_margin ml5" style="text-transform: lowercase">crashcourseonline.com</a>
                            </div>
                        </div>
                    </div>
                </div>
