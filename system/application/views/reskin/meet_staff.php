...
<div class="text-right" style="margin-right:8%;">		
  <span><a href="<?php echo base_url(); ?>">Home</a></span>		
    <span class="content">|Meet Our Staff
  </span> 		
</div>
    ...
    <div class="container">
    	<div class="grid">
    		...
    		//$image_path = $this->config->item('staff_image_upload_url');
                $image_path = $this->config->item('site_ssl_baseurl')."uploads/staff/";
    		...
    		$full_image = $this->config->item('staff_image_upload_path').$staff->photo;
						if($staff->photo && file_exists($full_image)){
							...
							$full_image = $this->config->item('site_ssl_baseurl').'images/noimg_round.png';							 
						}	
    			?>
