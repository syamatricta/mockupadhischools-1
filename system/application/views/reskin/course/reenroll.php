<?php
page_heading('Re-Enroll Course', 'banner-inner renewal-heading');
?>
<div class="text-right" style="margin-right:8%;">		
    <span><a href="<?php echo base_url(); ?>">Home</a></span>		
    <span class="content">|Re enroll</span> 		
</div>
<div class="container">
    ...
    <div class="row margin40">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <?php echo form_open("user/renewal/".$usercourse."/1", array('name'=>'renewcourse','id'=>'renewcourse'));?>
