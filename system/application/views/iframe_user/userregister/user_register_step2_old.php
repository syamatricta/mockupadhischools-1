       	...
       	<section>
            ...
            <div class="contactUs_Step1_Form">
            	<form name="registerform" id="myform" method="post" action="">
                    <div class="driving_license_div center">
                        <ul class="form_step_01">
                            <li class="clearboth" style="overflow:hidden;">
                                <label class="float_l">Your Drivers License Number* :</label>
                                <input type="text" name="driving_license" id="driving_license" maxlength="20"
                                class="usertextwidth float_l" value="<?php echo set_value('driving_license'); ?>" tabindex="1"/>
                            </li>
                        </ul>                        
                    </div>
