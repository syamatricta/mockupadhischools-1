	...
	<div class="clearboth"> </div>
		...
		<div class="admininnercontentdiv">
			...
			padding: 5px; background: none repeat scroll 0% 0% rgb(232, 227, 220);margin-bottom: 10px;">
                            ...
                            <div class="floatleft smallpaddingright">Course Status :  <br /><select id="course_completed" name="course_completed" style="width:115px;margin-top: 5px;">
                                    <option value="0" >all</option>
                                    <option <?php echo (isset($course_completed) && 1== $course_completed)?'selected':'';?>  value="1" >completed</option>
                                    <option <?php echo (isset($course_completed) && -1== $course_completed)?'selected':'';?>  value="-1" >Not completed</option>
                                </select>
                            </div>
                        ...
                        <div class="floatright"><a style="margin-right:10px;" href="#" id="export_users" onclick="fncsUserExport()">Export</a></div>
