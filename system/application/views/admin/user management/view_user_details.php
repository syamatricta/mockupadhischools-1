			...
			<div class="rightsidedata_view">
				...
				foreach($coursedetails as $course){
					if(''==$course->parent_course_name){
						print $course->course_name." - ".date('m/d/Y',strtotime($course->enrolled_date))."<br>";
					}
					else 
					{
						print $course->parent_course_name."(". $course->course_name.")"." - ".date('m/d/Y',strtotime($course->enrolled_date))."<br>";
					}
				}?></div>
			<div class="clearboth"></div>
                ...
                <div style="width:60%;float:left;position:relative">
                    <?php $this->load->view('admin/user management/_profile_progress');?>
                </div>
	</div>
	<?php }?>
