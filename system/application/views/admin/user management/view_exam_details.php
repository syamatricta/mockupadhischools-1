			...
			<div class="eto_info">
				...
				<div class="eto_info_row">
					...
					echo ($user_agent->platform_version!='unknown') ? '('.$user_agent->platform_version.')' : "";?>
                        ...
                        <?php
                        /*
                        if('' != $previous_attempts && count($previous_attempts) > 0){
                        ?>
                            <div class="other_exams">
                                    <div class="eto_heading">PREVIOUS ATTEMPTS</div>
                                    <div class="eto_info">
                                                <?php
                                                    foreach ($previous_attempts as $prev_attempts){

                                                ?>
                                                    <div class="eto_info_row">
                                                            <span class="etoi_l"><a target="_blank" class="other_exam_link" href="<?php echo site_url('admin_user/view_user_other_exam_details/'.$this->userid.'/'.$prev_attempts->course_id.'/'.$prev_attempts->id);?>"><?php echo $course_details->course_name ;?></a></span>
                                                            <span class="etoi_m">:</span>
                                                            <span class="etoi_r"><?php echo date('m-d-Y',strtotime($prev_attempts->started_at));?></span>
                                                    </div>
                                            <?php
                                                }
                                            ?>
