                ...
                <div class="listregistermain">
                   ...
                   <div class="register_step1_middle">
                        <div class="contents_registermain" >
                                ...
                                <div class="leftsideheadings_register">&nbsp;</div><input type="hidden" name="register_sub" id="register_sub"  value="0" />
                                <div class="middlecolon_register">&nbsp;</div>
                                <div class="rightsidedata_register">
                        ...
                        <div class="register_instructionmark" style="margin-top:15px;padding-right:10px; margin-right: 142px;">
