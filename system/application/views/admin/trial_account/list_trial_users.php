		...
		<div class="admininnercontentdiv">
			...
			<div class="listdata">
				...
				<div class="listdata" id="reason" style="display:none">
					<fieldset>
						...
						<div class="middlebutton">
                                                    <input type="hidden" id="hidfreezetype" name="hidfreezetype" />
                                                    <input type="button" name="butUpdate" value="Submit" onclick="javascript:changeTrialUserStatus();" />
                                                    <input type="button" name="butCancel" value="Cancel" onclick="javascript:hideTrialUserReasonInput();" />
						</div>
					</fieldset>
				</div>
				...
				<div class="admintopheads">
					...
					<div class="adminlistheadings" style="width:10%;">Created Date</div>
					<div class="adminlistheadings" style="width:13%;">First Name</div>
					<div class="adminlistheadings" style="width:13%;">Last Name</div>
					<div class="adminlistheadings" style="width:20%;">Email Id</div>
					<div class="adminlistheadings" style="width:14%;">Phone</div>
					<div class="adminlistheadings" style="width:8%;text-align:left;">Status</div>
				  ...
				  foreach($userdetails as $data){
                        ...
                        ?>
                                          <div class="<?php print($bg_color);?>">
                                                ...
                                                <div class="floatleft" style="width:10%;overflow: hidden"><?php echo formatDate($data->created_at); ?></div>
                                                <div class="floatleft" style="width:13%;overflow: hidden"><?php echo $data->first_name; ?></div>
                                                <div class="floatleft" style="width:13%;overflow: hidden"><?php echo $data->last_name; ?></div>
                                                <div class="floatleft" style="width:20%;overflow: hidden;"><?php if($data->email !='') {echo $data->email; } else { echo  '&nbsp' ;} ?></div> 
                                                <div class="floatleft" style="width:14%;"><?php echo ($data->phone !="") ? $data->phone : "<span style='visibility:hidden'>Nil</span>"; ?></div>                                                                                          
                                                <div class="floatleft" style="width:8%;text-align:left;">
                                                        ...
                                                        if('' != $data->change_status_reason){
                                                            echo '&nbsp; <a onmouseout="hide_tooltip()" 
                                                                onmouseover="open_tooltip(\''.htmlentities(addslashes($data->change_status_reason)).'\', \'#FFFFFF\', 200)"><img src="'.base_url().'images/log-icon.png" height="16" /></a>';
                                                ...
                                                <div class="floatleft" style="width:12%;text-align:center;">
                                                    <?php
                                                        if(1 == $data->status){
                                                            ...
                                                            echo '<a href="#" onclick="showTrialUserReasonInput('.$data->id.',\'freeze\')">Freeze</a>';
                                                        }else if(4 == $data->status){
                                                            echo '<a href="#" onclick="showTrialUserReasonInput('.$data->id.',\'unfreeze\')">Unfreeze</a>';
                                                        }                                                        
                                                    ?>
                                                </div>
                                          </div>
