                ...
                foreach ($reports as $data) {
                    ...
                    <div class="<?php print($bg_color); ?>" id="rowVal_<?php echo $data->adhi_attendance_report_id; ?>">
                        ...
                        <div class="floatleft" style="width:12%;overflow: hidden;text-align:center;">
                            <a href="<?php echo base_url(); ?>attendance_report/view_attendance/<?php echo isset($page_no) ? $page_no : 1; ?>/<?php echo $data->adhi_attendance_report_id;?>" alt="View" title="View">
                                <img src="<?php echo base_url(); ?>images/icon_img2.png" alt="View" title="View" height="18" style="margin-bottom:5px;margin-right: 3px;"/>
                            </a>
                            <a href="<?php echo base_url(); ?>attendance_report/edit_attendance/<?php echo isset($page_no) ? $page_no : 1; ?>/<?php echo $data->adhi_attendance_report_id;?>" alt="Edit" title="Edit">
                                <img src="<?php echo base_url(); ?>images/note.png" alt="Edit" title="Edit" height="20" style="margin-bottom:5px;"/>
                            </a>
