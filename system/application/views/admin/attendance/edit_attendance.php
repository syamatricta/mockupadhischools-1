...
<div class="adminmainlist">
	...
	<div class="admininnercontentdiv">
                ...
                <div style="width:100%;">
                    ...
                    <div> <input type="file" name="report" id="report" value="<?php echo ("" != $this->input->post("report")) ? $this->input->post("report") : $attendance_details->report; ?>"/></div>
                    <span style="color:red;"> Upload image file only </span>
                    
                    <?php if("" != $attendance_details->report){ ?>
                        <div style="text-align:center;"><img width="100" src="<?php echo base_url().'/image_uploads/attendance/'.$attendance_details->report; ?>"/></div>
                    <?php } ?>
                    <div class="clearboth paddingtop"></div>
                    ...
                    <div class="clearboth"></div>
                    <div> <textarea id="txtContent" name="txtContent" style="width:550px;"><?php echo ("" != $this->input->post("txtContent")) ? $this->input->post("txtContent") : $attendance_details->titled_guests; ?></textarea></div>
