...
<div  class="filedforrate"  >
	...
	<div style="float:left"><input type="radio"  class="bcheck" name="course_b" id="course_b" value="<?php echo $courses[0]->course_id; ?>" onClick="javascript:show_radio_package_check_opt(this.value,document.course.elements['course_b']), checkrate();"     />
	<label for="course_b"><?php echo "<b>$".$courses[0]->amount."</b>";?> - Our most comprehensive package available. This includes Real Estate
