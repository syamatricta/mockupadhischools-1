							...
							<div class="register_step1_middle"  >
								<div class="contents_registermain" >
									...
									<div class="rightsidedata_register"><input type="text" readonly name="name_on_certificate" id="name_on_certificate" class="textwidth" maxlength="255"  value="<?php echo $this->input->post('name_on_certificate'); ?>"/></div>
                                                                        ...
                                                                        <div class="leftsideheadings_register">Drivers License Number<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="driving_license" id="driving_license" class="textwidth" maxlength="20" value="<?php echo set_value('driving_license'); ?>"/></div>
									...
									<div class="leftsideheadings_register">&nbsp;</div>
                                                                        ...
                                                                        <div class="leftside_register">How did you hear about us<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register">
                                                                                <select name="testimonial"  id="testimonial"  class="selecttextwidth" onChange="javascript:change_hear_about_us(this.value);">
											<option value="" <?php echo (!array_key_exists('testimonial',$_POST) || $_POST['testimonial'] == "" ) ? "selected" : ""; ?>>Select</option>
                                                                                        <option value="Search engine" <?php echo (array_key_exists('testimonial',$_POST) &&  $_POST['testimonial'] == "Search engine")  ? "selected" : ""; ?>>Search engine</option>
                                                                                        <option value="Referral from a real estate office" <?php echo (array_key_exists('testimonial',$_POST) &&  $_POST['testimonial'] == "Referral from a real estate office")  ? "selected" : ""; ?>>Referral from a real estate office</option>
                                                                                        <option value="Facebook/YouTube/Twitter" <?php echo (array_key_exists('testimonial',$_POST) &&  $_POST['testimonial'] == "Facebook/YouTube/Twitter")  ? "selected" : ""; ?>>Facebook/YouTube/Twitter</option>
                                                                                        <option value="Friend" <?php echo (array_key_exists('testimonial',$_POST) &&  $_POST['testimonial'] == "Friend")  ? "selected" : ""; ?>>Friend</option>
                                                                                        <option value="Other" <?php echo (array_key_exists('testimonial',$_POST) &&  $_POST['testimonial'] == "Other")  ? "selected" : ""; ?>>Other</option>
                                                                                </select>
                                                                        </div>
                                                                        <div id="hh1_txt" style="<?php echo (array_key_exists('testimonial',$_POST) && $_POST['testimonial'] == "Search engine")  ? "display:block" : "display:none"; ?>"> 
                                                                                <div class="leftsideheadings_register">Enter Search Engine<span class="red_star">*</span></div>
                                                                                <div class="middlecolon_register">&nbsp;</div>
                                                                                <div class="rightsidedata_register">
                                                                                    <input type="text" name="txtSearchengine" id="txtSearchengine" class="textwidth"   value="<?php echo array_key_exists('txtSearchengine',$_POST) ? $_POST['txtSearchengine'] : ""; ?>" tabindex="18"/>
                                                                                </div>
                                                                        </div>
                                                                        <div id="hh2_txt" style="<?php echo (array_key_exists('testimonial',$_POST) && $_POST['testimonial'] == "Referral from a real estate office")  ? "display:block" : "display:none"; ?>"> 
                                                                                <div class="leftsideheadings_register">Which Real Estate Office<span class="red_star">*</span></div>
                                                                                <div class="middlecolon_register">&nbsp;</div>
                                                                                <div class="rightsidedata_register">
                                                                                    <input type="text" name="txtREO" id="txtREO" class="textwidth"   value="<?php echo array_key_exists('txtREO',$_POST) ? $_POST['txtREO'] : ""; ?>" tabindex="18"/>
                                                                                </div>
                                                                        </div>	
                                                                        <div class="clearboth"></div>
