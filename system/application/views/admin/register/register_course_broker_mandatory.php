...
<?php  		if($j == 6){ ?>
  				<div class="clearboth">&nbsp;</div>
			    <div class="admin_subhead_txt">Choose three from the bottom list </div>
				<div class="clearboth">&nbsp;</div>
<?php 		} ?>
			    <div  class="filedforrate" >
			       ...
			       <input type="checkbox" class="scheck" name="course[]" id="course<?php $courses_m['course_id']; ?>" value="<?php echo $courses_m['course_id']; ?>" onClick="javascript:showterms(this.value), checkrate();"  />
