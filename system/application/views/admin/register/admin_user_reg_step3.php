			 ...
			 <div class="admin_register_step2_billing_middle" >
				...
				<div class="contents_registermain">
					...
					<div class="rightsidedata_register">
						<input type="radio" checked="checked" <?php if(set_value('coursetype')== 'Live'){?> checked="checked" <?php }?> name="coursetype" id="coursetype" value="Live"  onclick="javascript:show_courses(this.value )">Live
