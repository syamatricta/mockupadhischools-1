						...
						<div class="listregistermain">
							...
							<div class="register_step1_middle"  >
								<div class="contents_registermain" >
									...
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="driving_license" id="driving_license" class="textwidth" maxlength="10" value="<?php echo set_value('driving_license'); ?>"/></div>
