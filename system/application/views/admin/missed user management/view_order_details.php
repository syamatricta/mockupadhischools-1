        ...
        <div class="admininnercontentdiv">
            ...
            <div class="listdata">
                ...
                foreach ($orderdet as $data) {
                    ...
                    <div class="rightsidedata_view"><strong><?php echo "# " . $data->temp_id; ?></strong></div>
                    <div class="clearboth"></div>
                ...
                echo $userdetails->firstname . " " . $userdetails->lastname;
                    ...
                    <div class="middlecolon">:</div>
                    <div class="rightsidedata_view"><?php echo anchor($this->current_controller . '/user_course_details/' . $data->userid . '/' . $data->temp_id . '/' . $this->uri->segment(4), 'Click here') ?> for Course Details</div>
                    <div class="clearboth"></div>
                    ...
                    <div class="rightsidedata_view"><?php
                        if ('0000-00-00' == $data->delivered_date) {
                            echo "Not Delivered";
                        } else {
...
<?php } else{ echo "No details captured"; }?>
    <div class="backtolist">
        <a href="javascript:void(null);" onclick="javascript:gotoMissedlist(<?php echo $this->uri->segment(4); ?>); return false;"><< Back to users list </a>
    </div>
...
<script>
    function gotoMissedlist(a){
        a?$("frmadhischool").action=base_url+"index.php/admin_missed_user/list_user_details/"+a:$("frmadhischool").action=base_url+"index.php/admin_missed_user/list_user_details/";
