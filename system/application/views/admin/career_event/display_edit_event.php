<div>
	...
	<div style="float:left;">
		...
		if(isset($class_mode)){
			...
			<select name="sltRegion" id="sltRegion"  class="mid-input" onchange="javascript: fncGetSubregion('sltRegion','sltSubregion');">
	...
	<div class="label_colon">:</div>
	<div>
            <input type="text" name="txtTitle" id="txtTitle" class="mid-input" value="<?php if($arr_event->title){echo $arr_event->title;}?>" />
	</div>
	<div class="clearboth paddingtop"></div>
	...
	<div class="clearboth"></div>
	<div> 
            <textarea id="txtParkingInfo" name="txtParkingInfo" style="width:544px;"><?php echo $arr_event->parking_info;?></textarea>
        </div>
