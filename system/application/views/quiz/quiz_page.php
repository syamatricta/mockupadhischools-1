...
<?php echo  form_open ('quiz/quizpage/', array('name'=>'quiz_form_adhi','id' => 'quiz_form_adhi', 'class' => '') ); ?>
		...
		<div>
			...
			<div id="divQuizContainer">
				<div id="divQuizlist" style="display:none;width:233px;">
								...
								foreach ($quiz_list as $data){ 
									if($data->quiz_status =='E'){ 
										...
										echo '<div class="floatleft">'
										     . '<input type="radio" name="rdnQuiz[]" id="rdnQuiz_'
										     . $i 
										     . '" value="'
										     . $data->id
				 	...
				 	<div class="changeQuizButton"><input type="image" src="<?php echo $this->config->item('images');?>innerpages/submit.jpg" onclick="javascript:return JSfncChangeQuiz('quiz_form_adhi');"/></div>
				</div>
			</div>
		</div>
	</div>
