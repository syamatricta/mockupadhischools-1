...
if (isset($meta_data_desc)){
    ...
    $mt_desc = "ADHI Schools is a real estate license school offering California students both live and online classes. Enroll in a free trial and start your real estate exam prep today!";
}

if(isset($mt_keyword) && "" != $mt_keyword){
    $meta_data['keyword'] = $mt_keyword;
}
...
<html lang="en">
  <head>
    ...
    <?php  $this->load->view("template/meta_header",array('mt_desc' => $mt_desc,'meta_data' => $meta_data)); ?>
    ...
    "@type": "School",		
    "name": "ADHI Schools, LLC",		
    "image": "https://www.adhischools.com/images/reskin/adhi_footer_logo.svg",		
    "brand": "ADHI Schools",		
    "alternateName": "Adhi Real Estate License Schools",		
    "email": "info@adhischools.com",		
    "logo": "https://www.adhischools.com/images/reskin/adhi_footer_logo.svg",		
    "description": "ADHI Schools offers a range of options to help individuals prepare for the California real estate licensing exam through live and online real estate classes",		
    ...
    "https://www.yelp.com/biz/adhi-schools-newport-beach",		
    ...
    "addressRegion": "CA",		
    "postalCode": "91762",		
    "streetAddress": "1063 West 6th Street, Second floor"		
    },		
    "contactPoint": {		
    "@type": "ContactPoint",		
    "telephone": "+1 888-768-5285",		
  ...
  <body>
                ...
                <div id="sidemenu-section" class="collapse navbar-collapse" >
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                        ...
                        <?php if($this->authentication->logged_in("normal")){?>
                            <?php if(!is_BRE_test_user()){ ?>
                                <?php if('Online' != $this->session->userdata('COURSE_TYPE')){ ?>
                                    <li class="visible-xs visible-sm"><a href="<?php echo base_url();?>find-real-estate-classes">Find a Class</a></li>
                                <?php }?>
                            <?php }?>
	                        ...
	                        <li class="hidden-xs hidden-sm"><a href="<?php echo base_url();?>contact-us" data-scroll="true" >Contact Us</a></li>
                                <?php if('Online' != $this->session->userdata('COURSE_TYPE')){?>
	                        <li class="hidden-xs hidden-sm"><a href="<?php echo base_url();?>find-real-estate-classes" data-scroll="true" >Find a Class</a></li>
                                <?php }?>
                        ...
                        <?php }else{?>
	                        ...
	                        <li><a href="<?php echo base_url();?>find-real-estate-classes" data-scroll="true" >Find a Class</a></li>
						...
						<li class="social-links">
                            <a href="https://www.facebook.com/adhischools" target="_blank"><i class="fa fa-facebook"></i></a>
                            ...
                            <a href="<?php echo base_url();?>blog" target="_blank"><i class="fa fa-wordpress"></i></a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
			...
			<div class="row">
				...
				<div class="col-sm-9 noplmd">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-6 nopadmd">
							<ul>
                                                            <li><a href="https://www.crashcourseonline.com">Crash course Online</a></li>
                                                            <?php if(!$this->authentication->logged_in("normal") || ( $this->authentication->logged_in("normal") && 'Online' != $this->session->userdata('COURSE_TYPE'))){ ?>
                                                                <li><a href="<?php echo base_url();?>find-real-estate-classes">Class schedule</a></li>
                                                            <?php }?>
						...
						<div class="col-sm-4 nopadmd col-xs-12">
							<div class="text-right social">
								...
								<a href="<?php echo base_url();?>blog" target="_blank"><span class="fa fa-wordpress"></span></a>
							</div>
    ...
    <?php if("firstteam" == $this->router->fetch_class()) { ?>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/bootstrap.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/jquery.validate.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/moment.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/fullcalendar.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/modernizr.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/owl.carousel.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/jquery.countTo.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/wow.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/user.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/masonry.pkgd.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/bootbox.min.js'; ?>"></script>
        <script language="JavaScript" src="<?php  echo $this->config->item('site_base_url').'js/reskin/rubick_pres_first_team.js'; ?>"></script>
    <?php } else { ?>
