<?php 	if($license == 'S'){?>
	 ...
	 <?php 	foreach($courses_o as $courses_o){ ?>
				<div  class="filedforrate"  > 
			        ...
			        <input type="radio"  class="bcheck" name="course_b" id="course_b<?php echo $courses_o['id']; ?>" value="<?php echo $courses_o['id']; ?>" onClick="javascript:show_opt_terms(this.value,document.course.elements['course_b']), checkrate();"     />
			    ...
			    <div class="filedforrate paddingbottom" id="showdiv<?php echo $courses_o['id']; ?>" style="display:none;" >
					<div class="agreementbox">
				   	...
				   	<div  class="filedforterm agreement" >
				        ...
				        <div class="agreementagreetext"><label for="agree<?php echo $courses_o['id']; ?>">I Agree</label></div>
				        ...
				        <div class="agreementdonttext"><label for="disagree<?php echo $courses_o['id']; ?>">I Don't Agree</label> </div>
				    </div>
		    	</div>
				<div class="clearboth"></div>
	<?php 	} ?>
