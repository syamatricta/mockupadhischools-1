<div class="floatleft">
	...
	<div class="contents_registermain" >
		...
		<div class="middlecolon_register">&nbsp;</div>
		<div class="rightsidedata_register"><input  type="text" name="cvv2no" class="textwidth" id="cvv2no" value="<?php echo set_value('cvv2no'); ?>" maxlength="10" size="25"/></div>
		<div class="clearboth"></div>
		...
		<div class="middlecolon_register">&nbsp;</div>
		<div class="rightsidedata_register">
			<img  src="<?php echo ssl_url_img();?>/innerpages/sub_btn.jpg" onclick="javascript:renew_course();" class="stylebutton" /><span  id="newimg" style="display:none;"></span>
		</div>
	</div>
</div>
<div class="clearboth"></div>