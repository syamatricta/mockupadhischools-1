...
<?php $ssl_css_url_path=  ssl_css_url_path(); ?>
    <link href="<?php echo $ssl_css_url_path.load_css_files($css) ; ?>" rel="stylesheet" type="text/css" />
     <link rel="shortcut icon" type="image/x-icon" href="<?php  echo ssl_url_img();?>favicon.ico">
...
<?php $ssl_js_url_path=  ssl_js_url_path(); ?>
	...
	<div class="outermaindiv">
		<div class="placelogo"><a href="<?php echo base_url();?>"><img  src="<?php  echo  ssl_url_img();?>adhilogo.jpg" alt="Real Estate Classes Los Angeles" title="Real Estate Classes Los Angeles" /></a></div>
		<div class="placeadhischool"><a href="<?php echo base_url();?>"><img  src="<?php  echo  ssl_url_img();?>adhischools.jpg" alt="adhischools" title="adhischools" /></a></div>
<?php /* header navigation starts here */?>
		<div class="headernavmain">
			...
			<div class="headermiddlenav">
				<div class="navigationmain">
					...
					<div class="headerleftnav"><img  src="<?php  echo  ssl_url_img();?>seperator.jpg" /></div>
					<div class="<?php echo $class; ?>"><?php  echo anchor('index.php/schedule','Schedules & Locations',array('title'=>'Real Estate License Classes'));?></div><!--$siteurl[9]->name-->
					<div class="headerleftnav"><img  src="<?php  echo  ssl_url_img();?>seperator.jpg" /></div>
		...
		<div id="innerpagemain">
			<div class="innerbackground_left"><img  src="<?php  echo  ssl_url_img();?>innerpages/inner_background_left.jpg" /></div>
