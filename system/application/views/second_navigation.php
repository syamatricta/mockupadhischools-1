<div class="nav_menu">
	<div class="nav_menu_right">
		<?php $class = ('find-real-estate-classes' == $this->uri->segment(1)) ? "find_a_class_menu1" : "find_a_class_menu"; ?>
		<a href="<?php echo base_url().'find-real-estate-classes'; ?>" class="<?php echo $class; ?>" rel="nofollow"></a>
