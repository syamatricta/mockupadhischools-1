						...
						<div class="listregistermain">
							...
							<div class="register_step1_middle"  >
								<div class="contents_registermain" >
									...
									<div class="rightsidedata_register"><input type="text" name="firstname" id="firstname" class="textwidth font-size_regpage_input" maxlength="128"  value="<?php echo set_value('firstname'); ?>"/></div>
									
									<div class="leftsideheadings_register">Last Name<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="lastname" id="lastname" class="textwidth font-size_regpage_input" maxlength="128"  value="<?php echo set_value('lastname'); ?>"/></div>
									<div class="clearboth"></div>
									<div class="leftside_register">Forum Alias<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register">
										<div style="float:left;"><input type="text" name="forumalias" id="forumalias" class="textwidth font-size_regpage_input" style="width:180px !important" maxlength="25"  value="<?php echo set_value('forumalias'); ?>"/></div>
										<div class="tooltip" style="width:20px;float:left; padding-top:10px;padding-left:2px;">
											...
											<a href="javascript:void(0);"><img style="margin-top:-7px;padding-right:3px;" src="<?php echo base_url().'images/help.jpg"' ?>" width="16" height="16" border="0"></a>
									...
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="email" id="email"  class="textwidth font-size_regpage_input" maxlength="128" value="<?php echo set_value('email'); ?>"/></div>
									
									<div class="leftsideheadings_register">Confirm E-mail<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="confirmemail" id="confirmemail" class="textwidth font-size_regpage_input" maxlength="128" value="<?php echo set_value('confirmemail'); ?>"/></div>
									<div class="clearboth"></div>
			
									<div class="leftside_register">Password<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="password" name="psword" id="psword"  class="textwidth font-size_regpage_input" maxlength="128"  value=""/></div>
									
									<div class="leftsideheadings_register">Confirm Password<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="password" name="psword1" id="psword1"  class="textwidth font-size_regpage_input" maxlength="128"  value=""/></div>
									<div class="clearboth">&nbsp;</div>
									<div class="leftside_register"> Contact Address<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="address" id="address"  class="textwidth font-size_regpage_input" maxlength="128" value="<?php echo set_value('address'); ?>"/></div>
									...
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="city" id="city" class="textwidth font-size_regpage_input" maxlength="128" value="<?php echo set_value('city'); ?>"/></div>
									<div class="clearboth"></div>
									<div class="leftside_register">Phone Number<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="phone" id="phone"   class="textwidth font-size_regpage_input" maxlength="25" value="<?php echo set_value('phone'); ?>"/></div>
									<div class="leftsideheadings_register">Zipcode<span class="red_star">*</span></div>
									<div class="middlecolon_register">&nbsp;</div>
									<div class="rightsidedata_register"><input type="text" name="zipcode" id="zipcode"  class="textwidth font-size_regpage_input" maxlength="5"  value="<?php echo set_value('zipcode'); ?>"/></div>
									<div class="clearboth"></div>
						...
						<div class="profile_personal_left"><img  src="<?php  echo ssl_url_img();?>register/reg_captcha_left.jpg" /></div>
							<div class="register_captcha_middle"  >
								<div class="contents_registermain" >
											...
											<div class="middlecolon_register">&nbsp;</div>
											<div class="rightsidedata_register"><input type="text" name="testimonial" id="testimonial"  class="textwidth font-size_regpage_input" maxlength="250"  value="<?php echo set_value('testimonial'); ?>"/></div>
											<div class="clearboth"></div>
											<div class="leftside_register">&nbsp;</div>
											<div class="middlecolon_register">&nbsp;</div>
											...
											<div class="middlecolon_register">&nbsp;</div>
											<div class="rightsidedata_register"><input type="text" name="captcha_code" id="captcha_code" class="textwidth font-size_regpage_input"  value="" /></div>
