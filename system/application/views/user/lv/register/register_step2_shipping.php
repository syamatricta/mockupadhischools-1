<div class="profile_personal_left"><img  src="<?php   echo ssl_url_img(); ?>register/reg_step2_biling_left.jpg" /></div>
 <div class="register_step2_billing_middle" >
	<div class="contents_registermain">
		...
		<div class="rightsidedata_register"> <input type="text" name="s_address" id="s_address"   class="textwidth font-size_regpage_input" maxlength="128" value="<?php if($this->session->userdata('address'))echo 	$this->session->userdata('address'); else echo set_value('s_address'); ?>" onblur="javascript:checkrate1(); "/></div>
		...
		<div class="middlecolon_register">&nbsp;</div>
		<div class="rightsidedata_register"><input type="text" name="s_city" id="s_city"   class="textwidth font-size_regpage_input" maxlength="40"  value="<?php if($this->session->userdata('city'))echo 	$this->session->userdata('city'); else echo set_value('s_city'); ?>" onblur="javascript:checkrate1(); "/></div>
		
		<div class="leftside_register">Zipcode<span class="red_star">*</span></div>
		<div class="middlecolon_register">&nbsp;</div>
		<div class="rightsidedata_register"> <input type="text" name="s_zipcode" id="s_zipcode"   class="textwidth font-size_regpage_input" maxlength="5" value="<?php if($this->session->userdata('zipcode'))echo 	$this->session->userdata('zipcode'); else echo set_value('s_zipcode'); ?>" onblur="javascript:checkrate1(); "/></div>
		<div class="clearboth"></div>
