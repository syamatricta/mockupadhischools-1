					...
					<div class="agreement_background">
						<div style="padding-left:30px;   padding-top:20px;">
					   	...
					   	<div  class="filedforterm agreement" >
					        ...
					        <div class="agreementagreetext" onclick="javascript:showpackage_opt_check(<?php echo $courses_o['course_id']; ?>,document.course.elements['course_b']),checkrate();">I Agree</div>
					        ...
					        <div class="agreementdonttext" onclick="javascript:showpackage_opt_uncheck(<?php echo $courses_o['course_id']; ?>,document.course.elements['course_b']),checkrate();">I Don't Agree</div>
					    </div>
					</div>
		    	</div>
				<div class="clearboth"></div>
