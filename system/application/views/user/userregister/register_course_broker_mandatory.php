...
<?php  		if($j == 6){ ?>
  				<div class="clearboth">&nbsp;</div>
			    <div class="subhead_txt margin-left58">Choose three from the bottom list </div>
				<div class="clearboth">&nbsp;</div>
<?php 		} ?>
					...
					<div class="filedforrate paddingbottom" id="showdiv<?php echo $courses_m['course_id']; ?>" style="display:none;" >
						...
						<div class="agreement_background">
						    ...
						    <div  class="filedforterm agreement" >
						        ...
						        <div class="floatleft"><img  src="<?php  echo ssl_url_img();?>checkbox_uncheck.png" width="25" height="24" id="disagree<?php echo $courses_m['course_id']; ?>" onclick="javascript:showuncheck(<?php echo $courses_m['course_id']; ?>), checkrate();"/><!--<input type="checkbox" name="disagree<?php echo $courses_m['course_id']; ?>" id="disagree<?php echo $courses_m['course_id']; ?>" value="<?php echo $courses_m['course_id']; ?>" onclick="javascript:showuncheck(this.value), checkrate();"  />--></div>
