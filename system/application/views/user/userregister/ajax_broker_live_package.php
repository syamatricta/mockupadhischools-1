<span class="package_span margin-left58">
    ...
    <input type="radio"  class="bcheck display-none" name="course_b" id="course_b" value="<?php echo $courses[0]->acpid; ?>" onClick="javascript:show_radio_package_check_opt(this.value,document.course.elements['course_b']), checkrate();"     />
...
<!--		<div  class="bcheck" name="course_b" id="course_b" onClick="javascript:show_radio_package_check_opt(<?php echo $courses[0]->acpid; ?>,document.course.elements['course_b']), checkrate();" style="font-size:30px; text-align:center; float:left; font-weight:bold; cursor:pointer; color:#A6CE35; width:118px; height:75px; background:url(<?php echo $this->config->item('images').'pricebox.png'; ?>) no-repeat ; padding:20px;"><?php echo "$".$courses[0]->amount;?></div>-->
		...
		<div style="float:left; margin-left:330px;"><a href="javascript:void(0);" rel="nofollow" style="color:#A5CE34" onmouseover="javascript:show_courses_list(); return false;" onmouseout="javascript:hide_courses_list(); return false;" class="show_me_btn">&nbsp;</a></div>
	</div>
	<div class="clearboth"></div>
	
	<div style="width:319px; height:248px; left:820px; top:220px; display: none; font-size:13px; background:url(<?php echo $this->config->item('images').'tooltip.png';?>) no-repeat ; " id="show_broker_livecourse"">
 ...
 <div class="filedforrate paddingbottom" id="showdiv<?php echo  $courses[0]->acpid; ?>" style="display:none;" >
	...
	<div class="agreement_background">
	    ...
	    <div  class="filedforterm agreement" >
	        ...
	        <div class="agreementagreetext" onclick="javascript:show_broker_packagecheck(<?php echo $courses[0]->acpid; ?>,<?php echo $courses[0]->amount; ?>), checkrate();">I Agree</div>
	        ...
	        <div class="agreementdonttext" onclick="javascript:show_broker_packageuncheck(<?php echo $courses[0]->acpid; ?>), checkrate();">I Don't Agree</div>
	    </div>
    </div>
</div>
<div class="clearboth">&nbsp;</div>
