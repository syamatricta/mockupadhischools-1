<div class="class_popup">
	...
	<div class="schedule_details_head"><?php echo $arr_class->region.' >> '.$arr_class->subregion;?></div>
	<div class="clearboth paddingbottom"></div>
		...
		<div class="details_data_contianer" style="margin-bottom:20px;height:auto;">
			...
			<div class="middelcolon_class">:</div>
			<div class="right_class"><?php echo strip_tags($arr_class->descp);?></div>
			<div class="clearboth paddingbottom"></div>
			
                </div>
<?php if(@$adhi_course->id != @$arr_class->course_id){ ?>        
<div class="details_head" style="line-height:15px;font-weight:normal;"> 
