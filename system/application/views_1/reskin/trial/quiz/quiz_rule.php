	    	...
	    	<div class="col-sm-12 ">
		    	<div class="jumbotron margin10">
		    		<div class="btnctr">
		    			...
		    			<div class="col-sm-6 text-left margin10"><a href="<?php echo site_url()."/trial_quiz/quizlist" . "/" . $course_id?>" class="btn-adhi"><i class="fa fa-remove"></i> Cancel</a></div>
...
<input type="hidden" id="user_type" value="trial" />
