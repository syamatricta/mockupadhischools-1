<div class="container">
    ...
    <p class="text-right loc-cnt wow fadeInUp"><a class="loc" href="https://adhischools.com/blog">View all Blogs &nbsp;<i class="fa fa-arrow-right"></i> </a></p>
    <div id="blog_view" class="owl-carousel">  
            ...
            ?>
                ...
                <div class="item  wow fadeInUp" data-wow-delay="<?php echo $i*.2;?>s" data-url="<?php echo str_replace('http:', 'https:', $post['url'])?>">
