     ...
     <div class="row">
        <div class="col-md-10 col-sm12 col-md-offset-1">            
           ...
           <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                          <textarea placeholder="NOTE TO ADHISCHOOLS" style="overflow-y: scroll;resize: none; height:44px;" name="note" id="note" maxlength="200"  class="form-control expand" ><?php echo set_value('note') ? set_value('note', s('note')) : $data['note'];  ?></textarea>
                  </div>
           </div>
