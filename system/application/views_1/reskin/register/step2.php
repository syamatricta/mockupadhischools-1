<form name="registerform_step2" id="registerform_step2" method="post">
    <div class="col-md-10 col-sm12 col-md-offset-1">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                <input type="text" placeholder="DRIVERS LICENSE NUMBER*" required name="driving_license" id="driving_license"  maxlength="20" class="form-control" value="<?php echo set_value('driving_license', s('driving_license'));?>" />
            </div>
        </div>
