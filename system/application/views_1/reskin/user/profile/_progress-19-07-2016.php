        ...
        <div class="checkout-wrap" id="profile_progress_bar">
            <ul class="profile-progress-bar">
                ...
                <li class="status <?php echo ($user_stat['registerd_in_crashcourse']) ? $user_stat['registerd_in_crashcourse']['class'] : '' ;?>">
                    ...
                    <div class="p_hover">You’ll want to register for our legendary <a target="_blank" href="http://www.crashcourseonline.com">crashcourseonline.com</a> site before you take the test</div>
                </li>

                <li id="state_exam_applied" class="status <?php echo ($user_stat['state_exam_applied']) ? $user_stat['state_exam_applied']['class'] : '' ;?>">
                    <div class="p_ti">Apply for state<br/>examination</div>
                    <div class="p_hover">Get your fingerprints done and click this <a target="_blank" href="http://www.adhischools.com/blog/forms-that-you-need-to-schedule-your-state-exam-salesperson-not-broker/">link</a></div>
                </li>
