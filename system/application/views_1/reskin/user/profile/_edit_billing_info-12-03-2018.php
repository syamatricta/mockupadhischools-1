    ...
    <div class="col-md-6  form-group">
        ...
        <select class="state form-control" id="b_state" name="b_state" required>
            ...
            <?php foreach($states as $single_state){?>
                <option value="<?php echo $single_state->state_code; ?>" <?php echo select_selected_ext('state', $single_state->state_code, @$b_state->state_code);?>><?php echo $single_state->state;?></option>
            <?php }?>
        </select>  		
    </div>
    <div class="col-md-6 form-group">
