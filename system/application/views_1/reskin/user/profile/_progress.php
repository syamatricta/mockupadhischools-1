        ...
        <div class="checkout-wrap" id="profile_progress_bar">
            <ul class="profile-progress-bar">
                ...
                <li id="state_exam_applied" class="status <?php echo ($user_stat['state_exam_applied']) ? $user_stat['state_exam_applied']['class'] : '' ;?>">
                    ...
                    <div class="p_hover">Get your fingerprints done and click this <a target="_blank" href="https://www.adhischools.com/blog/forms-that-you-need-to-schedule-your-state-exam-salesperson-not-broker/">link</a></div>
                </li>
