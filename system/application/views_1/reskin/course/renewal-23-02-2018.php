                        ...
                        <input type="hidden" name="b_country" id="b_country" value="US" >
                            <select class="state form-control" id="b_state" name="b_state" required>
                                ...
                                <?php foreach($state as $state){?>
                                        <option value="<?php echo $state['state_code'] ?>" <?php echo select_selected_ext('b_state', $state['state_code'], isset($billing['b_state']) ? $billing['b_state'] : set_value('b_state'));?>><?php echo $state['state']?></option>
                                <?php }?>
                            </select>  		
                    </div>
