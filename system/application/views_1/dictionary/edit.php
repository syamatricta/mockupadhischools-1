		...
		<div  class="page_error" id="display_server_error" align="center">				
				...
				<div class="floatleft" style="width:45%;"> 
					<?php
						...
						if(isset($_POST['dctKeyword']) && '' != $_POST['dctKeyword']) {
							...
							$keyword = $dictionary_detail[0]['dct_keyword'];
						}
					?>
				...
				<div class="floatleft" style="width:45%;"> 
					<?php
						...
						if(isset($_POST['dctDefinition']) && '' != $_POST['dctDefinition']) {
							...
							$definition = $dictionary_detail[0]['dct_definition'];
						}
					?>
			...
			<div class="form-fields"  style="height:20px">
				...
				<div  class="floatleft" style="width:10%;">
					<input type="submit" value="Save" onclick="javascript:return validate_dictionary_details();">
				</div>
			</div>
			<div class="backtolist"> 
				<input type="hidden" name="hdn_offset_val" id="hdn_offset_val" value="<?php echo $offset_val;?>">
 				<a href="<?php echo site_url().'dictionary/dictionary_list/'.$offset_val;?>"><< Back to Listing Page</a>
			</div>
		</div>
	</div>
</form>