    ...
    <div class="right_cntnr">
        <div class="right_cntnr_bg_hd">
             <div class="floatleft" style="width:100%">
	             <div class="sitepagehead"><h1>Take Final Exam</h1></div>
        ...
        <div class="right_cntnr_bg">
			...
			<div id="maindiv" style="padding-top:100px">
				<div class="quizlist_main" >
					...
					<div style="float:right; padding-bottom:5px; padding-right:50px; display:none ">
					...
					<div class="quizrepreat">
						...
						<div class="time"><span style="color:#FDE401; font-size:16px;">Time </span> / 2.30 hrs</div>
						<?php /* functional part */?>
							...
							<div class="examstartbuttons" id="confirm">
								...
								<div class="middlebutton">
									<div class="headernavmain" >
										...
										<img src="<?php echo $this->config->item('images').'innerpages/start-exam.png'?>" alt="Start Examination" id="strtexm" style="cursor:pointer" onclick="javascript:exam_rule('<?php echo site_url().'exam/exam_start/'.time();?>');" /></div>
			                            <div style="float:left;width:213px;height:54px; padding-left:20px; padding-bottom:20px;" align="left">
			                               	<img src="<?php echo $this->config->item('images').'innerpages/cancel.png'?>" alt="Cancel" style="cursor:pointer" onclick="javascript:cancel_confirm('<?php echo site_url()."exam/courselist"?>');" />                        
