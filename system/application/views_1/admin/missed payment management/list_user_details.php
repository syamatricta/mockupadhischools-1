<?php
$form_action = (2 == s('ADMINTYPE')) ? $this->current_controller . '/list_renew_reenroll_details' : $this->current_controller;
            ...
            foreach ($userdetails as $data) {
                ...
                <div class="<?php print($bg_color); ?>">
                    ...
                    <div class="floatleft" style="width:<?php echo $column7; ?>;text-align:center;">
                        <?php echo anchor($this->current_controller . '/view_renew_users/' . $data->id . '/' .$data->order_id. '/' . $segment, 'View') ?>
                    </div> 
                    <div class="floatleft" style="width:<?php echo $column8; ?>;text-align:center;"><?php echo anchor($this->current_controller . '/user_renew_course_details/' . $data->id . '/' . $data->order_id . '/' . $segment, 'Course Details') ?></div> 
                    <div class="floatleft" style="width:<?php echo $column9; ?>;text-align:center;"><?php echo anchor($this->current_controller . '/view_renew_order_details/' . $data->id . '/' . $data->order_id . '/' . $segment, 'Order Details') ?></div> 
                </div>
                <div class="clearboth"> </div>
        <?php
        $count++;
