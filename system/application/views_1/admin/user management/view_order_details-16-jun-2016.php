...
<?php /* Freezing of a user with reason ends here  */?>
		<div class="listdata">
			...
			foreach($orderdet as $data){?>
				...
				<div class="middlecolon">:</div>
				<div class="rightsidedata_view"><?php echo anchor('admin_user/user_courses/'.$data->userid.'/'.$data->id.'/'.$this->uri->segment(4),'Click here')?> for Course Details</div>
				<div class="clearboth"></div>
				...
				<div class="middlecolon">:</div>
				<div class="rightsidedata_view"><?php echo $userdetails->s_address; ?><br>
												<?php echo $userdetails->s_city. ", ". $s_state->state; ?><br>
												<?php echo $userdetails->s_country. ", ". $userdetails->s_zipcode; ?><br></div>
				<div class="clearboth"></div>
				...
				<?php if('Q'== $data->status){?><div class="floatright" style="width:20%;">
