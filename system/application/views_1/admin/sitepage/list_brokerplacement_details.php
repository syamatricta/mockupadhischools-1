...
<div class="adminmainlist">	
		...
		<div class="admininnercontentdiv">
			<div class="list_regionadd"><a href="<?php echo base_url().'admin_sitepages/add_brokerplacement';?>">Add Broker placement</a></div>
			<div class="listdata">
				<div class="admintopheads">
					<div class="adminlistheadings" style="width:10%; text-align:center;">Sl. No</div>
					<div class="adminlistheadings" style="width:80%;">Postcode</div>
<!--					<div class="adminlistheadings" style="width:50%;">Short Description</div>-->
			...
			<div class="clearboth"> </div>
		<?php 
		if(count($brokerplacement) > 0){
	/* list headings ends here*/
			$count=1; 
		   	if ($this->uri->segment(3)){
				$count = $count+$this->uri->segment(3);
			} 
			foreach($brokerplacement as $data){
	...
	/* data list starts here */ 
		?>
						<div class="<?php print($bg_color);?>">
						 	...
						 	<div class="floatleft" style="width:80%;"><?php echo $data->sub_postcode; ?></div>
<!--						 	<div class="floatleft" style="width:50%;"><?php //echo $data->banner_short_dec; ?></div> -->
						 	<div class="floatleft" style="width:5%;text-align:center;"><?php echo anchor('admin_sitepages/edit_brokerplacement/'.$data->id,'Edit');?></div>
						 	<div class="floatleft" style="width:5%;text-align:center;"><a href="javascript:void(0);" onclick="javascript:deletebrokerplacement(<?php echo $data->id;?>);">Delete</a></div>
						</div>
						<div class="clearboth"> </div>
		<?php 
				$count++; 
	...
	<?php } else { ?>
		<div class="nodata">No Broker placement</div>
	<?php }?> 
</div>
<input type="hidden" id="hidbrokerplacementId" name="hidbrokerplacementId"  value="" />
<?php echo form_close();?>