<?php 	if($license == 'S'){?>
  ...
  <?php 	foreach($courses_o as $courses_o){ ?>
				<div  class="filedforrate"  > 
			        ...
			        <input type="radio"  class="bcheck" name="course_bp" id="course_b<?php echo $courses_o['course_id']; ?>" value="<?php echo $courses_o['course_id']; ?>" onClick="javascript:show_opt_terms(this.value,document.course.elements['course_b']), checkrate();"     />
			        <label for="course_b<?php echo $courses_o['course_id']; ?>"><?php echo $courses_o['course_name']; ?></label>
			    ...
			    <div class="filedforrate paddingbottom" id="showdiv<?php echo $courses_o['course_id']; ?>" style="display:none;" >
					<div class="admin_agreementbox">
				   	...
				   	<div  class="filedforterm agreement">
				   		<div class="agreementagreecheck"><input type="checkbox" name="agree<?php echo $courses_o['course_id']; ?>" id="agree<?php echo $courses_o['course_id']; ?>" value="<?php echo $courses_o['course_id']; ?>" onclick="javascript:showpackage_opt_check(<?php echo $courses_o['course_id']; ?>,document.course.elements['course_b']),checkrate();"></div>
				        <div class="admin_agreementagreetext"><label for="agree<?php echo $courses_o['course_id']; ?>">I Agree</label></div>
				        <div class="floatleft"><input type="checkbox" name="disagree<?php echo $courses_o['course_id']; ?>" id="disagree<?php echo $courses_o['course_id']; ?>" value="<?php echo $courses_o['course_id']; ?>" onclick="javascript:showpackage_opt_uncheck(<?php echo $courses_o['course_id']; ?>,document.course.elements['course_b']),checkrate();" ></div>
