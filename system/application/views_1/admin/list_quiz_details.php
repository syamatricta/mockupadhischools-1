...
/* list headings starts here*/		
		...
		<div class="floatleft" style="width:20%;">
			...
			<div class="admintopheads">
				...
				<div class="adminlistheadings" style="width:10%;">No of Persons Taking Quiz</div>
				<div class="adminlistheadings" style="width:11%;">Quiz Status</div>
				<div class="adminlistheadings" style="width:10%;">Excel Sheet</div>                                
				<div class="adminlistheadings" style="width:7%;">Edit</div>
	...
	/* data list starts here */ 
				 ?>
				  <div class="<?php print($bg_color);?>">
				 	...
				 	<div class="floatleft" style="width:10%;"><?php echo $data['ex_count'];?></div>
				 	<div class="floatleft" style="width:11%;">&nbsp;
						...
						<?php } ?>
                                        ...
                                        <div class="floatleft" style="width:10%;">
                                            <a href="<?php echo base_url()?>admin_quiz/download/<?php  echo $data['id'] ?>">Download</a>
                                        </div>
