<div>
		...
		<select name="sltCourses" id="sltCourses" onchange="showCapacity()">
                    ...
                    if($course_list){
                            foreach ($course_list as $data){
                                    echo '<option value="'.$data->id.'" ';if(isset($arr_event->instructor_id) && $arr_event->course_id==$data->id){echo 'selected';}echo ' >'.$data->course_name.'</option>';
                            }
                    }
                    ?>
		</select>
            ...
            <select name="instructor" id="instructor">
                    ...
                    if($instructor_list){
                            foreach ($instructor_list as $instructor){
                            	   ...
                            	   $sel =($instructor->id==set_post_value('instructor',@$arr_event->instructor_id))?'selected':'';
                                    echo '<option '.$sel.' value="'.$instructor->id.'" ';echo ' >'.$instructor->name.'</option>';
                            }
                    }
                    ?>
            </select>
	...
	<div id="capacityDiv" <?php if($arr_event->course_id!=15) {?>style="display:none;" <?php } ?>>
		<div class="clearboth paddingtop"></div>
	
		<div class="label_style">Capacity<span class="red_star">*</span></div>
		<div class="label_colon">:</div>
		<div>
			<input type="text" name="capacity" id="capacity"  value="<?php echo $capacity; ?>" size="10"/>
		</div>
	</div>
	<div class="clearboth paddingtop"></div>
