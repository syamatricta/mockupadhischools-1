            	...
            	<form name="registerform" id="myform" method="post" class="form_step_01" action="<?php echo base_url().'iframe_user/register/'.$site;?>" >
                        ...
                        <ul class="form_step_01">
                            ...
                            <li class="clearfix">
                                ...
                                <div id="fedexMsg" style="width:240px;margin-left: 1px; top: 610px;display:none;position:absolute;background-color: lightyellow;border: 3px solid #999999;padding: 2px;z-index: 100;"><div style="padding:10px 10px;background-color:#000; color:#FFF;font-size:13px;">FedEx will not deliver to P.O. Boxes</div></div> 
                                </div>                      	
                            </li>    
                            <li class="clearfix">
                            	<div class="float_l">
								...
								<div class="float_r">
                                 ...
                                 <div class="float_l">
                                	 ...
                                	 <div id="dd" class="wrapper-dropdown-5 max_dropdown" tabindex="10">
                                        ...
                                        <input type="hidden" name="state" id="state" value="DC" />
                                    </div>
                                </div>
                            ...
                            <li class="clearfix">
                                ...
                                <div class="float_r">
                                  <label>Note </label>
                                  <textarea style="overflow-y: scroll;resize: none;" name="note" id="note" maxlength="200"  
                                            class="usertextwidth"  tabindex="13">
                                                <?php echo set_value('note') ? set_value('note') : (isset($data['note'])) ? $data['note'] : '';  ?></textarea>
