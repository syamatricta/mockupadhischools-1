            	...
            	<form name="registerform" id="myform" method="post" class="form_step_01" action="<?php echo base_url().'iframe_user/register/'.$site;?>" >
                        ...
                        <ul class="form_step_01">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="float_r">
                                  <label>Note </label>
                                  <textarea style="overflow-y: scroll;resize: none;" name="note" id="note" maxlength="200"  class="usertextwidth"  tabindex="13"><?php echo set_value('note') ? set_value('note') : $data['note'];  ?></textarea>
