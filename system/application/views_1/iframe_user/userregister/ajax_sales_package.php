...
<span class="package_span margin-left58">
    ...
    <input type="radio"  class="bcheck display-none" name="course_p" id="course_b"
           value="<?php echo $courses[0]->course_id; ?>"
           data-books-count = "<?php echo $courses[0]->books_count; ?>"
           onClick="javascript:show_radio_package_check_opt(this.value,document.course.elements['course_p']), checkrate();"     />
    <label for="course_b"><b>Pick this package:</b></label> <br></span>
...
<!--		<div  class="bcheck" name="course_b" id="course_b" onClick="javascript:show_radio_package_check_opt(<?php echo $courses[0]->course_id; ?>,document.course.elements['course_b']), checkrate();" style="font-size:30px; text-align:center; float:left; font-weight:bold; color:#A6CE35; width:118px; height:75px; cursor:pointer; background:url(<?php echo $this->config->item('images') . 'pricebox.png'; ?>) no-repeat ; padding:20px;"><?php echo "$" . $courses[0]->amount; ?></div>-->
    ...
    <div class="filedforrate paddingbottom agreement_background" id="showdiv<?php echo $courses[0]->course_id; ?>" style="display:none;" >
        <div class="license_agreement_wrapper">
            ...
            <div class="custom_checkbox clearfix">
                <div  class="filedforterm agreement" >
                    ...
                    <div class="agreementagreetext fl" onclick="javascript:showpackagecheck(<?php echo $courses[0]->course_id; ?>,'<?php echo $courses[0]->amount; ?>'),checkrate();">I Agree</div>
                    ...
                    <div class="agreementdonttext fl" onclick="javascript:showpackageuncheck(<?php echo $courses[0]->course_id; ?>,document.course.elements['course_b']),checkrate();">I Don't Agree</div>
                    <div class="cb"></div>
                </div>
            </div>
            <?php /* ?>
    ...
    <?php
        ...
        $this->load->view("iframe_user/userregister/register_course_sales_package_optional");
    ?></div>
    <div class="clearboth">&nbsp;</div>
    <!-- New Package -->
    <span class="package_span margin-left58">
    ...
    <input type="radio"  class="bcheck display-none" name="course_p_newpackage"
           id="course_b_newpackage"
           value="<?php echo $courses_newpackage[0]->course_id; ?>"
           data-books-count = "<?php echo $courses_newpackage[0]->books_count; ?>"
           onClick="javascript:show_radio_package_check_opt_newpackage(this.value,document.course.elements['course_p_newpackage']), checkrate();"     />
    <label for="course_b_newpackage"><b>Pick this package:</b></label> <br></span>
<div style="margin-left:30px;">
<div  class="">
    ...
    <div style="float:left;  padding-top:20px;" class="margin-left58">
        ...
        <input type="button" class="button_green" value="<?php echo "$" . $courses_newpackage[0]->amount; ?>" />
    ...
    <div class="clearboth"></div>
    <?php /* Terms and condition For Principle */ ?>
    <div class="filedforrate paddingbottom agreement_background" id="showdiv_newpackage<?php echo $courses_newpackage[0]->course_id; ?>" style="display:none;" >
        <div class="license_agreement_wrapper">
            <div class="example">
                <div id="main_content" style="height:90%;">
                    <div class="parent">
            ...
            <div class="custom_checkbox clearfix">
                <div  class="filedforterm agreement" >
                    <div class="agreementagreecheck fl"><img  src="<?php echo ssl_url_img(); ?>checkbox_uncheck.png" width="25" height="24" id="agree_newpackage<?php echo $courses_newpackage[0]->course_id; ?>" onclick="javascript:showpackagecheck_newpackage(<?php echo $courses_newpackage[0]->course_id; ?>,'<?php echo $courses_newpackage[0]->amount; ?>'),checkrate();"/></div>
                    <div class="agreementagreetext fl" onclick="javascript:showpackagecheck_newpackage(<?php echo $courses_newpackage[0]->course_id; ?>,'<?php echo $courses_newpackage[0]->amount; ?>'),checkrate();">I Agree</div>
                    <div class="fl"><img  src="<?php echo ssl_url_img(); ?>checkbox_uncheck.png" width="25" height="24" id="disagree_newpackage<?php echo $courses_newpackage[0]->course_id; ?>" onclick="javascript:showpackageuncheck_newpackage(<?php echo $courses_newpackage[0]->course_id; ?>,document.course.elements['course_b_newpackage']),checkrate();"/></div>
                    <div class="agreementdonttext fl" onclick="javascript:showpackageuncheck_newpackage(<?php echo $courses_newpackage[0]->course_id; ?>,document.course.elements['course_b_newpackage']),checkrate();">I Don't Agree</div>
                    <div class="cb"></div>
                </div>
            </div>
