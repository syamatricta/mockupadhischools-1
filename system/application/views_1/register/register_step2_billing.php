<div class="profile_personal_left"><img  src="<?php  echo ssl_url_img(); ?>register/reg_shipping_left.jpg" /></div>
 <div class="register_step2_shipping_middle" >
	<div class="contents_registermain" >
		...
		<div class="rightsidedata_register"><input type="text" name="b_address" id="b_address" class="textwidth" maxlength="128"  value="<?php echo set_value('b_address'); ?>" onblur="javascript:checkrate1(); "/></div>
		...
		<div class="middlecolon_register">&nbsp;</div>
		<div class="rightsidedata_register"> <input type="text" name="b_zipcode" id="b_zipcode"  class="textwidth" maxlength="5" value="<?php echo set_value('b_zipcode'); ?>" onblur="javascript:checkrate1(); "/></div>
		<div class="clearboth"></div>
