<div class="floatleft">
	...
	<div class="contents_renewmain" >
		...
		<div class="rightsidedata_register" style="width:330px; float:right; padding-right:250px; padding-top:30px;">
			<img style="padding-right:10px;"  src="<?php  echo ssl_url_img();?>submitting.png" alt="Submit" onclick="javascript:addnewcourses();hidealert();" class="stylebutton" />
			<a href="<?php echo base_url().'exam/courselist'?>" rel="nofollow" ><img src="<? echo $this->config->item('images').'cancel.png'?>" alt="Cancel" style="cursor:pointer" /></a><span  id="newimg" style="display:none;"></span>
		</div>
	</div>
</div>
<div class="clearboth"></div>