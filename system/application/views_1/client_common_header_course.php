...
<?php $ssl_js_url_path=   ssl_js_url_path(); ?>
	...
	<div class="outermaindiv">
		<div class="placelogo"><a href="<?php echo $this->config->item('site_baseurl')?>index.php/home/"><img  src="<?php  echo  ssl_url_img();?>adhilogo.jpg" alt="Real Estate Classes Los Angeles" title="Real Estate Classes Los Angeles" /></a></div>
		<div class="placeadhischool"><a href="<?php echo $this->config->item('site_baseurl')?>index.php/home/"><img  src="<?php  echo  ssl_url_img();?>adhischools.jpg" alt="adhischools" title="adhischools" /></a></div>
