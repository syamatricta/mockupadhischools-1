...
<div class="reg_step2_box_middle">
	<div class="reg2_box_add_inner">
		...
		<div style="padding-bottom:10px;"><input type="checkbox" name="setaddr" id="setaddr" onclick="javascript:setBillingAddr();">Billing address same as shipping address<span style="display:none;" id="indicator">loading</span></div>
