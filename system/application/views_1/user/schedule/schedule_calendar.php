...
<div style="float:left;width:760px;margin-left: 200px;">
		...
		<div style="width:300px; padding-left:100px">
			<div class="cal_month_left floatleft" style="padding-right:30px; ">
				<a rel="nofollow" href="javascript: void(0);" title="<?php echo $previous_month_text;?>" onclick="javascript: fncGetNextCalendar(<?php echo $previous_month;?>,'m',0);">
					<img  src="<?php echo base_url().'images/calendar_month_left.png'?>"/>
				</a>
			</div>
			...
			<div class="cal_month_right floatleft" style="padding-left:30px;">
				<a rel="nofollow" href="javascript: void(0);" title="<?php echo $next_month_text;?>" onclick="javascript: fncGetNextCalendar(<?php echo $next_month;?>,'m',1);">
					<img src="<?php echo base_url().'images/calendar_month_right.png'?>"/>
				</a>
			</div>
		</div>
	</center>
				...
				if($day>0 && $day<=$total_days_of_current_month)
				{
					...
					if(@array_key_exists($day,$events))
					{
                                            ...
                                            $clr=array();$crsnam=array();
                                                ...
                                                echo ' class="date_has_event" height="50"   onmouseover="javascript:return show_calclass('.$day.');" onmouseout="javascript:return hide_calclass('.$day.');" onClick="Javascript:return fncShowEventList('.$day.','.$current_month.','.$current_year.');"';
                                                }
						echo '>';
                                                echo '<div ';echo 'style="text-align:center; width:68px; font-size:20px; color:#000; padding-top:14px; z-index:300;"'; echo ' onmouseover="javascript:return show_calclass('.$day.');" onmouseout="javascript:return hide_calclass('.$day.');">'.$day;
...
<!--                                                    </span>-->
    ...
    <div style="float:left;width:200px; margin-left:20px; margin-top:<?php echo $htrghdiv;?>px">
		...
		echo '<div style="float:left;font-size:13px;color:#7E7E7E;width:210px;line-height:18px;background:url('.$this->config->item('sq_image_url').'small_77/'.@$crse_color[$data->id].'.png) no-repeat center left;padding:0 0 0 20px;">'.$data->course_name.'</div>';
	    }
	} ?>
    </div>
