...
<?php 
	...
	<div class="filter_container">
		...
		<div class="floatleft">
			<select name="sltSearchRegion" id="sltSearchRegion" onchange="javascript: fncGetSubregion('sltSearchRegion','sltSearchSubregion');" <?php if(isset($class_mode)){ echo 'disabled';}?> style="width:150px;">
		...
		<div id="divSubregion" class="filter_subregion">
			<select name="sltSearchSubregion" id="sltSearchSubregion" <?php if(isset($class_mode)){ echo 'disabled';}?> onchange="javascript: fncDisplayDefaultList(<?php echo $today_timeline;?>,<?php echo date('j',strtotime('-8 hour'))?>,<?php echo date('n',strtotime('-8 hour'))?>,<?php echo date('Y',strtotime('-8 hour'))?>);" style="width:150px;">
				<option value="0">Select</option>
				<?php 
		...
		<div class="floatleft">
			<select name="sltSearchCourse" id="sltSearchCourse" <?php if(isset($class_mode)){ echo 'disabled';}?> onchange="javascript: fncDisplayDefaultList(<?php echo $today_timeline;?>,<?php echo date('j',strtotime('-8 hour'))?>,<?php echo date('n',strtotime('-8 hour'))?>,<?php echo date('Y',strtotime('-8 hour'))?>);" style="width:150px;">
				<option value="0">Select</option>
				<?php
				if($course_list){
                ...
                <div class="floatleft" id="chter_cnt" style="display:none;">
                    ...
                    <div class="floatleft">
			<select name="sltSearchChp" id="sltSearchChp" <?php if(isset($class_mode)){ echo 'disabled';}?> onchange="javascript: fncDisplayDefaultList(<?php echo $today_timeline;?>,<?php echo date('j',strtotime('-8 hour'))?>,<?php echo date('n',strtotime('-8 hour'))?>,<?php echo date('Y',strtotime('-8 hour'))?>);" style="width:150px;">
				<option value="0">Select</option>
				<?php
				if($chp_list){
