				...
				if($this->checkUserUniqueLogin($row->USERID,$row->EMAIL,$login['forced_login'])){
						...
						$response['msg']="Already logged in, please login forcefully";	
                            ...
                            if(0 == $user->status){
                                ...
                                $response['msg']            = 'You are already upgraded Trial account to Adhi user. But some technical issue in login, please email info@adhischools.com
or call 888 768 5285';
