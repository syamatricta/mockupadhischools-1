...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	class Ifrschedule extends Controller
{
	/**
	 * General contents
	 */
	...
	function Ifrschedule () {
		...
		$this->gen_contents['css'] 			= array('style.css','client_style.css','user_calendar_style.css','modalbox.css','ifr_schedule.css');
		$this->gen_contents['js'] 			= array('ifr_schedule.js','effects.js','popcalendar.js','modalbox.js','custom_element.js');
	...
	function _home_template ($page,$contents){
		...
		$this->load->view('user/ifr_schedule/'.$page, $contents);
	...
	{ 
		...
		$this->load->view("user/ifr_schedule/ifr_schedule_header",$this->gen_contents);
		$this->load->view('user/ifr_schedule/display_schedule_new', $this->gen_contents);
	}
	/**
	...
	function _date($time, $course='', $region='', $sub_region=''){
		...
		$this->load->view('user/ifr_schedule/schedule_calendar',$this->gen_contents);
		}
	...
	function display_list(){
		$this->load->model('admin_schedule_model');
		$this->gen_contents['modal_path'] 	= 'ifrschedule/class_details';
		...
		$this->load->view('user/ifr_schedule/display_list_event',$this->gen_contents);
	}
	/**
	...
	function class_details() {
		...
		$this->load->view('user/ifr_schedule/display_schedule_details', $this->gen_contents);
	}
