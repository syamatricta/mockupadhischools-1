					...
					$this->_init_registration_rules_step3();	
						...
						//	if($result > 0){
                          if($result > 0 || $result_forum > 0) {
								...
								$this->Iframeuser_model->send_mailto_admin($this->mail_contents,$this->order_contents,$this->session->userdata{'admindetails'},$this->order_updates);
