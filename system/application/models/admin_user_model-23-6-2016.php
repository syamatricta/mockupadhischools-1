...
class Admin_user_model extends Model{
	 ...
	 * @return userdetails
	 */
	function select_userdetails ($num,$offset = 0,$srchFname = '',$srchLname = '',$srchEmail = '', $srcLicense = '', $src_phone = '', $src_zip = '') {
            $this->db->select ("*");
	 ...
	 */
	function qry_count_userdetails ($srchFname = '',$srchLname = '',$srchEmail = '', $srcLicense = '', $src_phone = '', $src_zip = ''){
...
//                 $u_res=mysql_fetch_array($exe);
	...
	*/	
	 ...
	 * @return userdetails
	 */
	function select_userdetails_completed ($num,$offset = 0,$srchFname = '',$srchLname = '',$srchEmail = '', $srcLicense = '', $src_phone = '', $src_zip = '') {
	 ...
	 * @return count of users
	 */
	function qry_count_userdetails_completed ($srchFname = '',$srchLname = '',$srchEmail = '', $srcLicense = '', $src_phone = '', $src_zip = ''){
