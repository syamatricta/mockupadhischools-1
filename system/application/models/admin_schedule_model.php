...
class Admin_schedule_model extends Model{
	...
	function dbSelectSingleSubRegion($id){
		...
		$this->db->select ("subregion_name AS sub_name,sub.id AS id,region.region_name AS region,region.id AS regionid");
		$this->db->select ("subregion_description,image_name,subregion_address,subregion_meta,subregion_meta_keyword,latitude,longitude,postcode");
	...
	function dbSelectSelcCrashCourse () {
        ...
        function dbGetUpcomingClassDetailsForSubregion($subregion_id,$date, $details = 1, $subregion){
