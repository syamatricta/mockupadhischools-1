...
class Admin_legacy_student extends Controller {
        ...
        private function _create_pdf($data){
            ...
            $this->fpdf->Cell(20);
            $this->fpdf->cell(20,10,$data->address,0,0,'L');
            $this->fpdf->Ln(5);
            ...
            $this->fpdf->MultiCell(25, 8, convert_UTC_to_PST_date_slash($data->enrolled_date) , 1,1);		
        ...
        /*$y2 = $this->fpdf->GetY();
            ...
            $y = $this->fpdf->GetY();
            $this->fpdf->SetXY($x + 103, $this->fpdf->GetY()-$yH);
            $this->fpdf->Cell(18, $yH, convert_UTC_to_PST_date_slash($data->enrolled_date) , 1,1);	
            ...
            $this->fpdf->Cell(20, $yH, convert_UTC_to_PST_date_slash($data->exam_date) , 1,1);	
            ...
            $this->fpdf->Cell(45);
            $this->fpdf->Cell(80,4, convert_UTC_to_PST_date_slash($data->enrolled_date),0,1,'R');
            $this->fpdf->Ln(10);
            $this->fpdf->Cell(25);
