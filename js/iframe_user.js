   ...
   function checkuserregister_2(uid){  
	...
	function show_courses(id,selval){ 
            ...
            if(id==1){
                ...
                if(coursetype =='Live'){
                        $('online_pack').hide(500);
                        $('online_pack_1').hide(500);
                        $('online_pack_2').hide(500);
                        $('pack_divider').hide(500);
                        $('class_pack').show(500);
                        $('class_pack_1').show(500);
                        $('class_pack_2').show(500);
                    ...
                    $("coursetypeo").className="button_red btn btn_withArrow";
                        ...
                        $('class_pack').hide(500);
                        $('class_pack_1').hide(500);
                        $('class_pack_2').hide(500);
                        $('pack_divider').hide(500);
                        $('online_pack').show(500);
                        $('online_pack_1').show(500);
                        $('online_pack_2').show(500);
                	$("preferred_colorp").checked=false;
                	$("preferred_colorc").checked=false;
	...
	function checkshipmethod(){ 
		...
		if(checkzip($('s_zipcode')) == true || checkzip($('b_zipcode')) == true){
            ...
            var book_count  = 0;
            console.log('preferred_color checked '+$$('input[type="radio"][name="preferred_color"]:checked]').length);
            if($$('input[type="radio"][name="preferred_color"]:checked]').length > 0
                && 'Package' == $$('input[type="radio"][name="preferred_color"]:checked')[0].value){//if user selects Package
                ...
                if('S' == $('hidlicensetype').value){//Course type Sales
                    if($$('input[name="course_b_newpackage"]:checked').length > 0){
                        book_count = $$('input[name="course_p_newpackage"]:checked')[0].readAttribute('data-books-count');
                    }else{
