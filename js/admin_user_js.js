...
function fncsUserExportBrokerage(){
    $('user_export_form').method = "post";
    $('user_export_form').action = base_url+'brokerage/list_export_to_excel';
    $("user_export_form").submit();
}

function gotobrokerlist(a){
    a?$("frmadhischool").action=base_url+"index.php/brokerage/list_user_details/"+a:$("frmadhischool").action=base_url+"index.php/brokerage/list_user_details/";
    $("frmadhischool").submit()
}
