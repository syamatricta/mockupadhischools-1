...
var Accordion = Class.create({ 
    ...
    attachInitialMaxHeight: function() {
        ...
        if(this.current.getHeight() != this.maxHeight) this.current.setStyle({height: "auto"}); //this.maxHeight+"px"
    },
    ...
    animate: function() {
        ...
        var options = {
            ...
            scaleMode: {
                originalHeight: "auto",//this.maxHeight
        ...
        new Effect.Parallel(effects, {
            ...
            afterFinish: function() {
                this.current.hide();
                this.toExpand.setStyle({ height: "auto" });//this.maxHeight+"px"
